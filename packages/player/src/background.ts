 ...
 *  NOTE: a long iOS-PWA background pause still can't be revived from here — the
 *  audio session is handed off to another app and the context/element are torn
 *  down beyond what resume()+play() (or a route rebuild, tried and reverted) can
 *  recover. Treated as a known limitation; see AUDIO / the iOS notes. */

...
const VISUAL = [
  ...
  "src/__tests__/vfd-shakedown.svelte.test.ts",
  "src/__tests__/vfd-plate.svelte.test.ts",
  "src/__tests__/hifi-deck.svelte.test.ts",
  "src/__tests__/scroller-board.svelte.test.ts",
  "src/__tests__/flip-board.svelte.test.ts",
  "src/__tests__/board-departures.svelte.test.ts",
];
